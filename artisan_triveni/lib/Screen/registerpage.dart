...
class _RegisterpageState extends State<Registerpage> {
  ...
  Future<String?> _uploadImage(
    ...
    try {
      final fileName = 'artisan_${artisanId}_$type';

      await supabase.storage.from('artisan').upload(fileName, imageFile);
  ...
  Future<void> register() async {
    try {
      ...
      String? imageUrl = await _uploadImage(_image!, artisanId, "profile");
      ...
      print("Error registering artisan: $e");
    }
  }
